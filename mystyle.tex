...
\definecolor{subtitle}{rgb}{0.81,0.81,0.81}
...
\newcommand{\DUroleemail}[1]{\g@addto@macro\infolinks{%
    \hspace{.7em}\href{mailto:#1}{\faEnvelope}}}%
...
\newcommand{\DUrolephone}[1]{\g@addto@macro\infolinks{%
    \hspace{.7em}\href{tel:#1}{\faPhone}}}%
...
\newcommand{\MYNAME}{\raisebox{0pt}{\Huge \sffamily \bfseries \color{brbg72}\@title}%
\color{subtitle}\raisebox{0pt}{\hskip 0.8em \parbox[b]{\textwidth}{\linespread{0.8}\firaheavy Software \\ Engineer}}}
\newcommand{\MyName}{{\Large \sffamily \bfseries \color{brbg72}\@title}}
\newcommand{\MYINFO}{{\Large \infolinks}}
\newcommand{\MyInfo}{}
\makeatother
